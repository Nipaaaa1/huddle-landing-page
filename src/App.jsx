const App = () => {
  return (
    <>
      ...
      <p>
        Huddle re-imagines the way we build comunities. You have a voice, but so
      ...
      <div>
        <svg className="size-10" viewBox="0 0 320 512">
        ...
        <svg className="size-10" viewBox="0 0 448 512">
        ...
        <svg className="size-10" viewBox="0 0 512 512">
